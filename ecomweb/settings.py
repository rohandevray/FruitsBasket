...
SECRET_KEY = 'django-insecure-!lrb#yf&kd$cw3!jozhv%@8y1ckoy@(k2&pw#-+)6wm3om#!(n'
...
EMAIL_HOST_PASSWORD = 'nzjznfqoawizszzh'  #app password so we dont have to use original password to logins
